...
<div class="create">
    ...
    <form class="form" name="gallery" action="<?= $router->route("form.create"); ?>" method="post"
        ...
        <input type="radio" id="masculino" name="genre" value="M" /><label for="masculino">Masculino</label>
        <input type="radio" id="feminino" name="genre" value="F" /><label for="feminino">Feminino</label>
